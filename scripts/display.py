...
def main():
    ...
    try:
        ...
        for round_idx in range(args_cli.num_rounds):
            ...
            if hasattr(robot, 'set_all_flipper_positions'):
                ...
                robot.set_all_flipper_positions(flipper_angles, degree=True, clip_value=60)
                robot.set_all_flipper_position_targets(flipper_angles, degree=True, clip_value=60)
            ...
            for i in range(args_cli.settle_steps):
                ...
                actions = torch.ones((env.num_envs, unwrapped_env.action_space.shape[1]), device=unwrapped_env.device) * 0.1
